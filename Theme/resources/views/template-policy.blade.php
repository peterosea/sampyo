  ...
  <div class="container xl:max-w-screen-xl mx-auto">
    <section class="mb-30px sm:mb-70px">
      <div class="prose tracking-[-0.16px]">
        <p>
          주식회사 삼표(이하 ‘회사＇라 합니다)는 고객님의 개인정보를 중요시하며, ‘정보통신망 이용촉진 및 정보보호＇에 관한 법률을 준수하고 있습니다. 회사는 개인정보처리방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 회사는 개인정보처리방침을 개정하는 경우 웹사이트를 통하여 공지할 것입니다.
        </p>
      </div>
    </section>
    <section>
      ...
      <div class="border border-dugong p-30px lg:p-60px prose text-14px tracking-[-0.17px]">
        ...
        <div class="mb-40px">
          ...
          <p>
            개인정보정책은 본 사이트 및 회사의 웹사이트에 관한 것입니다. 본 사이트로 링크된 다른 회사의 개인정보처리방침은 별도로 확인하시기 바랍니다.
          </p>
