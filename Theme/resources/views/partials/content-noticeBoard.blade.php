  ...
  <div class="more flex gap-x-10 items-center">
    ...
    <div x-data="{ isOpen: false }" class="relative inline-block text-left">
      <div>
        ...
        <button @click="isOpen = !isOpen"  type="button" class="inline-flex justify-center w-full items-center gap-4 font-light disabled:opacity-20" id="menu-button" aria-expanded="true" aria-haspopup="true" style="outline: none !important" @if (empty($attechedFiles)) disabled @endif>
          첨부파일
