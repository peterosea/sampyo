...
<div class="container lg:max-w-screen-lg mx-auto">
  ...
  <p>
    사업 활동의 모든 측면에 지속가능성이 포함됩니다. 사람 ∙ 사회 ∙ 환경을 배려하고, 더 나은 미래를 만들기 위한 사회적 임팩트를 중시합니다. 사회와 환경에 긍정적인 영향을 미치는 공유 가치를 만들어감으로써 이해 관계자들에게 긍정적인 경험을 제공하고자 합니다. 
  </p>
  <div class="mb-24"></div>
  <div class="coverbox-full left py-28">
    ...
    <p>
      사회공헌 활동은 사회적 임팩트(Social Impact)을 만들기 위한 기초입니다. 건설 소재 사업에서 연유하는 환경에 대한 부정적 영향을 최소화하기 위해 노력합니다. 지속가능한 미래를 만들기 위해 사람 ∙ 사회 ∙ 환경에 대한 책임감을 지향점으로 삼아 지역 사회, 파트너 및 구성원과의 신뢰 구축을 최우선 활동으로 추진합니다.  
    </p>
    <div class="mb-24"></div>
    <div class="flex -mx-9">
  ...
  <div class="flex -mx-6 mb-14">
    ...
    <div class="w-1/2 px-6 prose">
      <p>
        정인욱 명예회장은 사재를 출연하여 기업의 이윤을 사회로 환원하며, 기업의 사회적 책임을 수행했습니다. 사회 전체의 이익을 증진시키고 국민 생활 향상을 도모하면서 사회에 필요한 인재를 발굴하고 육성하고자 했습니다. 이러한 취지에 따라, 정인욱 명예회장의 차남 정도원 삼표 그룹 회장이 부친의 유지를 이어받아 2002년부터 매년 10억 원을 재단에 출연하여 총자산 200억 원 규모를 넘는 건실한 재단으로 성장하였습니다. 
      </p>
    </div>
  </div>
  ...
  <div class="mb-20"></div>
  <div class="flex -mx-9 mb-32">
    <div class="w-1/3 px-9">
      <div class="letter__box text-5xl mb-7">
        <span class="letter__box-value">250</span><span class="letter__box-unit">억원</span>
      </div>
      <div class="text-xl font-bold mb-2.5">재단 기금</div>
      <div class="prose">
        <p>
          매년 10억원 이상의 장학기금을 출연하여 기업이익의 사회환원을 실천하고 있습니다.
        </p>
      </div>
    </div>
    <div class="w-1/3 px-9">
      <div class="letter__box text-5xl mb-7">
        <span class="letter__box-value">5,807</span><span class="letter__box-unit">명</span>
      </div>
      <div class="text-xl font-bold mb-2.5">장학금 수혜인원</div>
      <div class="prose">
        <p>
          설립 후 지금까지 연평균 200여명의 학생에게 장학금을 지급하였으며, 학술연구 단체에 연구비를 지원하고 있습니다.
        </p>
      </div>
    </div>
    <div class="w-1/3 px-9">
      <div class="letter__box text-5xl mb-7">
        <span class="letter__box-value">66</span><span class="letter__box-unit">억원</span>
      </div>
      <div class="text-xl font-bold mb-2.5">장학금 및 학술연구 지원액</div>
      <div class="prose">
        <p>
          연평균 약 2억원을 중,고,대학생들에게 장학금과 학술연구 지원금으로 지급하고 있습니다.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="grid grid-cols-2 gap-x-12 gap-y-4 mb-32">
    ...
    <div class="prose">
      <p>
        삼표의 제품과 기술로 만들어진 건축 재료인 초고성능 콘크리트 (UHPC)를 활용한 업사이클링 벤치입니다.<br/>
        시민들의 일상에 편안한 휴식을 드리고자 하는 마음을 담았습니다. 삼표만의 재료와 기술을 담은 의자를 거리 곳곳에서 편하게 만나볼 수 있습니다. 
      </p>
    </div>
    <div>
      <img
    ...
    <div class="prose">
      <p>
        삼표는 지역 사회의 추운 겨울에도 손길을 내밉니다. 삼표그룹의 모태인 강원산업의 대표 제품이었던 연탄을 지역 사회의 에너지 취약 계층 가구에 전달하고 있습니다. 생필품인 쌀이 부족한 저소득 가구를 임직원이 직접 방문해 전달하는 참여형 봉사 활동을 실시합니다.  
      </p>
    </div>
  </div>
