...
<div class="container xl:max-w-screen-xl mx-auto">
  <div class="page__level-title mb-px-30 sm:mb-20">
    고객과 사회의 지속가능한 발전에 힘이 되는 기업이 되겠습니다.
  </div>
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-7 sm:gap-y-28 mb-px-30 sm:mb-20">
    <div class="prose">
      <p class="mb-10">
      ...
      <p class="mb-10">
        급속한 경제 발전에 따른 대규모의 고품질 주택과 건설 수요에 대처하기 위해 끊임없는 기술 혁신과 고품질의 제품을 안정적으로 공급하여 고객 및 파트너와 함께 대한민국의 인프라 구축에 전력을 다했습니다. 
      </p>
      <p class="mb-10">
    ...
    <div class="prose">
      <p class="mb-10">
        이제 세상은 새로운 도전 과제에 직면했습니다. 기후 위기로 대변되는 지구온난화를 해결하기 위해 이산화탄소를 줄이고 폐자원의 활용과 관리 등 순환자원의 가치를 높여야 합니다. 
      </p>
      <p class="mb-10">
        삼표그룹은 대한민국의 지속 가능한 발전을 위해 사업 전 영역에서 탄소제로 2050을 목표로 탄소 감축을 이루겠습니다.
      </p>
      <p class="mb-10">
        <b>
          천연광산을 필두로 산림자원 개발과 새로운 가치를 캐내는 도시광산까지 사업을 다각화하고 지구환경 보호를 위한 환경자원 분야의 성장에 사명감을 가집니다. 
        </b>
      </p>
      <p>
        <b>
          기술과 혁신을 통해 물류 등 사회 인프라 구성에 필요한 다양한 요구를 충족시키기 위해 노력합니다. 또한 협력사와 지역사회는 물론 모든 이해관계자와 동반성장을 통한 공동체의 발전을 추구합니다. 
        </b>
      </p>
    </div>
  </div>
