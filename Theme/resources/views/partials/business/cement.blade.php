...
<div class="container xl:max-w-screen-xl mx-auto">
  ...
  <div class="coverbox-full left pb-32 pt-24 mb-60px sm:mb-28">
    ...
    <div class="mb-30px sm:mb-16">
      <p>
        삼표시멘트는 제품과 서비스를 넘어 지속가능한 미래를 만들기 위하여 기업의 혁신문화를 촉진하고 있으며, 긍정적인 사회적, 환경적 성과를 달성하기 위해 노력을 아끼지 않습니다. 삼표시멘트는 1980년 에너지 파동 시 국내최초로<br/>
        소성로의 연료를 벙커C유에서 유연탄으로 대체하였으며, 2004년에는 소성로의 폐열을 이용하여 전기를 생산하는 폐열발전소를 가동하였습니다.
      </p>
    </div>
