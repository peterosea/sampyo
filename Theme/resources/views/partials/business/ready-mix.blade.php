    ...
    <div>
      <div class="prose">
        <p>
          ...
          또한, 선진물류 인프라를 구축하고 믹서트럭 운영 최적화를 위한 지원시스템을 강화하는 등 고객 니즈에 부응하고 있습니다. 더불어 자체 품질관리 기준인 <a href="#SKS">SKS(Sampyo KS)</a>를 개발 운영하여 최고의 품질을 유지하고 있습니다.
        </p>
      </div>
    </div>
    <div>
    ...
    <div>
      <div class="flex flex-col justify-between h-full">
        <div class="prose mb-30px sm:mb-16">
          ...
          <p>
            <span class="pointUnderLine" style="--bs: var(--RGB-atmosphere)">삼표의 특수 레미콘 브랜드 블루콘입니다</span>
          </p>
          <p>
            블루콘은 일반 콘크리트가 지닌 재료적 한계성을 다양한 건설환경에 따라 개선시킨 프리미엄 레미콘 브랜드입니다. 지속적으로 고객요구를 반영하여 그 성능을 향상시키고 있습니다. 블루콘은 일반 콘크리트 특성(강도, 작업성, 내구성)보다 특별한 성능을 제공하여 현장의 환경 조건에 대응하고, 고객의 어려움을 해결해 줄 수 있으며, 고객이 사용시 체감할 수 있는 특수한 성능을 제공하여 고객의 니즈를 만족시킵니다. 블루콘은 사용 목적에 따라 5종의 제품으로 공급됩니다.
          </p>
        </div>
        <div>
