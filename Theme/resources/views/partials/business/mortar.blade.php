...
<div class="container xl:max-w-screen-xl mx-auto">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-[30px] sm:gap-y-16">
    ...
    <div class="prose">
      <p>
        출범 2년 만에 시장 점유율 20%이상을 확보한 삼표 몰탈은 원재료를 계열사로부터 안정적으로 수급/생산하고 있으며, 화성, 인천, 김해에 위치한 3곳의 공장은 연 250만톤을 공급능력을 보유하고 있으며, 지역 거점을 기반으로 전국 공급망 체계를 구축하고 있어 고객이 원하는 제품을 신속, 정확하게 공급합니다. 
      </p>
      <p>
