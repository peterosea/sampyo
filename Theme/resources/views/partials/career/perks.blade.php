  ...
  <div class="container lg:max-w-screen-lg mx-auto">
    ...
    @php
      $benefits = [
        ...
        [
          "title" => "리프레시 지원",
          "content" => "하계/동계 휴가(비) 지급. 리프레시(Refresh) 휴가 제도와 콘도미디엄 지원을 통해 몸과 마음의 재충전을 돕고 있습니다. (보유 콘도 및 리조트 - 대명, 한화, 금호, 리솜 등 다수 회원권 보유)"
        ],
        [
          "title" => "기숙사 운영",
        ...
        [
          "title" => "복지포인트 지급",
          "content" => "사내복지몰(폐쇄몰)을 운영하여 임직원들이 필요한 것들을 구매할 수 있도록 복지포인트를 지급합니다."
        ],
      ]
    @endphp
