...
<div class="container xl:max-w-screen-xl mx-auto">
  ...
  <div class="coverbox-full left py-px-50 sm:py-28">
    <div class="page__level-title mb-4">
      사회 공헌활동의 지향점
    </div>
    <p>
    ...
    <div class="pb-px-70 sm:pb-24"></div>
    <div class="relative">
      <div id="csrOriginal" class="grid grid-cols-3 gap-x-px-72 z-0 sm:z-10 invisible sm:visible absolute left-0 top-0">
  ...
  <div class="pb-px-70 sm:pb-24"></div>
  <div class="page__level-title mb-px-20  sm:mb-14">
    사회공헌 활동
  </div>
  <div class="text-2xl font-black underline power mb-7">인재 육성</div>
  <div class="grid grid-cols-1 sm:grid-cols-2 mb-px-20 sm:mb-14 gap-y-4">
    <div class="prose">
      <p>
  ...
  <div class="relative mb-px-20 sm:mb-16">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4 mb-px-20 sm:mb-16">
    <div>
  ...
  <div class="grid grid-cols-1 gap-y-px-20 sm:gap-y-12">
    <div>
