      ...
      <div class="home__s3-body">
        <div id="originalS3" class="hidden sm:flex">
          <div id="cardWrap" class="w-1/3 flex justify-center">
            ...
            <div class="card__s1">
              <div data-sal="slide-up" style="--sal-duration: 0.8s" data-sal-delay="300" class="card__s1-thumbnail"><img src="{{ get_theme_file_uri('resources/images/53.svg') }}"></div>
          ...
          <div id="cardWrap" class="w-1/3 flex justify-center">
            @php($post = array_shift($sustainability))
            <div class="card__s1">
              <div data-sal="slide-up" style="--sal-duration: 0.8s" data-sal-delay="400" class="card__s1-thumbnail"><img src="{{ get_theme_file_uri('resources/images/57.svg') }}"></div>
              <div class="card__s1-body">
                <div class="card__s1-title">{!! $post->post_title !!}</div>
                <div class="card__s1-content">
                  ‘기업과 사회가 함께하는 것이<br/>
          ...
          <div id="cardWrap" class="w-1/3 flex justify-center">
            @php($post = array_shift($sustainability))
            <div class="card__s1">
              <div data-sal="slide-up" style="--sal-duration: 0.8s" data-sal-delay="500" class="card__s1-thumbnail"><img src="{{ get_theme_file_uri('resources/images/56.svg') }}"></div>
              <div class="card__s1-body">
                <div class="card__s1-title">{!! $post->post_title !!}</div>
                <div class="card__s1-content">
...
<div class="section home__s45">
    ...
    <div class="container mx-auto flex flex-wrap lg:block lg:mb-[150px]">
      <ul id="originalS4" class="home__s4-container hidden lg:flex relative z-10">
        ...
        @foreach ($career as $item)
          <li data-sal="slide-up" style="--sal-duration: 0.8s" data-sal-delay="{!! 300 - (50 * $index) !!}" id="cardWrap" class="w-1/3">
            <a href="{!! $item->permalink !!}">
              <div class="card__s2">
                <div class="card__s2-header">
                  <div class="arrow m_lg:w-[52px]">
      ...
      <div class="home__s4-content text-white order-1 static lg:absolute z-50 text-center lg:text-left mb-[60px] lg:mb-0 m_lg:mx-auto">
  ...
  <div class="section home__s5 mt-[10px] sm:mt-0 m_sm:pb-2.5">
